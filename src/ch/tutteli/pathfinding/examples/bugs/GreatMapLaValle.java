...
public class GreatMapLaValle
{
    ...
    public static void main(String[] args) {
        ...
        WorldView worldView = WorldHelper.setupWorldView("GreatMapLaValle", world, image, pixelFactor);
        worldView.setVisible(true);
        try {
            Thread.sleep(2000);
        } catch (InterruptedException ex) {
        }
        IPathFinder pathFinder = new DStarKlesk(world);
