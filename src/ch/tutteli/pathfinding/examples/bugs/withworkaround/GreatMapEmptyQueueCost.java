...
import ch.tutteli.pathfinding.examples.bugs.DStarEmptyQueue;
 ...
 */
public class GreatMapEmptyQueueCost
{
    ...
    public static void main(String[] args) {
        ...
        WorldView worldView = WorldHelper.setupWorldView("Workarounds - GreatMapEmptyQueueCost", world, image, pixelFactor);
        worldView.setVisible(true);
        try {
            Thread.sleep(2000);
        } catch (InterruptedException ex) {
        }
        IPathFinder pathFinder = new DStarEmptyQueueCost(world);
