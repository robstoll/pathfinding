 ...
 */
public class GreatMapExceptionCost
{
    ...
    public static void main(String[] args) {
        ...
        WorldView worldView = WorldHelper.setupWorldView("Workarounds - GreatMapExceptionCost",world, image, pixelFactor);
        worldView.setVisible(true);
        try {
            Thread.sleep(2000);
        } catch (InterruptedException ex) {
        }
        IPathFinder pathFinder = new DStarExceptionCost(world);
