...
import ch.tutteli.pathfinding.examples.bugs.DStarException;
 ...
 */
public class GreatMapException
{
    ...
    public static void main(String[] args) {
        ...
        WorldView worldView = WorldHelper.setupWorldView("Workarounds - GreatMapException",world, image, pixelFactor);
        worldView.setVisible(true);
        try {
            Thread.sleep(2000);
        } catch (InterruptedException ex) {
        }
        IPathFinder pathFinder = new DStarException(world);
