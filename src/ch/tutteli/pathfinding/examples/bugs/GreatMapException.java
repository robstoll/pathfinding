...
public class GreatMapException
{
    ...
    public static void main(String[] args) {
        ...
        Tile startTile = world.getTile(27, 57);
        Tile endTile = world.getTile(16, 13);
        ...
        WorldView worldView = WorldHelper.setupWorldView("GreatMapException", world, image, pixelFactor);
